        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">失物展示展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              ...
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="shiwuleixing" id="shiwuleixing" placeholder="失物类型" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('shiwuzhanshi','新增')" @click="jump('../shiwuzhanshi/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../shiwuzhanshi/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-prslist-tit" @click="jump('../shiwuzhanshi/detail.jsp?id='+item.id)"><span>{{item.shiwubiaoti}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#shiwubiaoti').val()) {
          param['shiwubiaoti'] = jquery('#shiwubiaoti').val() ? '%' + jquery('#shiwubiaoti').val() + '%' : '';
        }  
        if (jquery('#shiwumingcheng').val()) {
          param['shiwumingcheng'] = jquery('#shiwumingcheng').val() ? '%' + jquery('#shiwumingcheng').val() + '%' : '';
        }  
        if (jquery('#shiwuleixing').val()) {
          param['shiwuleixing'] = jquery('#shiwuleixing').val() ? '%' + jquery('#shiwuleixing').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('shiwuzhanshi/list', 'get', param, function(res) {
