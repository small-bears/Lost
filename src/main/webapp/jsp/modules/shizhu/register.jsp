	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">失主号</label> 
							<input type="text" name="shizhuhao" placeholder="失主号" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="mima" placeholder="密码" class="form-control-i">
																								...
																								<div class="form-group">
							<label class="label">失主名</label> 
							<input type="text" name="shizhuming" placeholder="失主名" class="form-control-i">
							</div>
																								<div class="form-group">
							<label class="label">门牌号</label> 
							<input type="text" name="menpaihao" placeholder="门牌号" class="form-control-i">
							</div>
																								<div class="form-group">
							<label class="label">联系方式</label> 
							<input type="text" name="lianxifangshi" placeholder="联系方式" class="form-control-i">
							</div>
																								<div class="form-group">
							<label class="label">电子邮箱</label> 
							<input type="text" name="dianziyouxiang" placeholder="电子邮箱" class="form-control-i">
							</div>
