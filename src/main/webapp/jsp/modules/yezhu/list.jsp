...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>业主管理</span></li>
								<li class="breadcrumb-item active"><span>业主列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="menpaiSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('menpai')">门牌<i id="menpaiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#menpaiSearch').val() != null && $('#menpaiSearch').val() != ''){
				searchForm.menpai ="%" +  $('#menpaiSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var menpaiCell  = document.createElement('td');

						 menpaiCell.innerHTML = item.menpai;


			row.appendChild(menpaiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yezhu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"yezhu");
