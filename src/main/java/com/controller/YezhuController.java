...
public class YezhuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		YezhuEntity user = yezhuService.selectOne(new EntityWrapper<YezhuEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody YezhuEntity yezhu){
    	...
    	YezhuEntity user = yezhuService.selectOne(new EntityWrapper<YezhuEntity>().eq("zhanghao", yezhu.getZhanghao()));
		if(user!=null) {
