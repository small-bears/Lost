...
public class ShizhuController {
    @Autowired
    private ShizhuService shizhuService;
    ...
    public R list( ShizhuEntity shizhu){
       	EntityWrapper<ShizhuEntity> ew = new EntityWrapper<ShizhuEntity>();
      	ew.allEq(MPUtil.allEQMapPre( shizhu, "shizhu")); 
        return R.ok().put("data", shizhuService.selectListView(ew));
    }
    ...
    public R query(ShizhuEntity shizhu){
        EntityWrapper< ShizhuEntity> ew = new EntityWrapper< ShizhuEntity>();
 		ew.allEq(MPUtil.allEQMapPre( shizhu, "shizhu")); 
		ShizhuView shizhuView =  shizhuService.selectView(ew);
		return R.ok("查询失主成功").put("data", shizhuView);
    }
    ...
    public R info(@PathVariable("id") Long id){
        ShizhuEntity shizhu = shizhuService.selectById(id);
        return R.ok().put("data", shizhu);
    }
     ...
     */
    @RequestMapping("/save")
    public R save(@RequestBody ShizhuEntity shizhu, HttpServletRequest request){
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ShizhuEntity> wrapper = new EntityWrapper<ShizhuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = shizhuService.selectCount(wrapper);
